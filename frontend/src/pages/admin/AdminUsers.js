...
const AdminUsers = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-800">Kullanici Yönetimi</h1>
        <p className="text-gray-600 mt-2">Tüm kullanıcıları görüntüleyin, düzenleyin ve yönetin</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="cover">Yönetici Olanlar</option>
              <option value="notCover">Normal Kullanıcı Olanlar</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div>
            <span className="text-gray-600">Toplam Kullanıcılar: </span>
            <span className="font-semibold">{filteredImages.length}</span>
          </div>
          <div>
            <span className="text-gray-600">Yönetici Kullancılar: </span>
            <span className="font-semibold">
              {filteredImages.filter(img => img.isCover).length}
            </span>
          </div>
          <div>
            <span className="text-gray-600">Normal Kullanıcılar: </span>
            <span className="font-semibold">
              {filteredImages.filter(img => !img.isCover).length}
            </span>
          </div>
